  ...
  children: [
    ...
    // The dynamic layout supports both the main layout and the sideblock.
    {
      ...
      children: [
        {
          index: true,
          element: <Navigate to="/desktop/home/overview" />,
        },
        {
          path: "/desktop",
          children: [
            ...
            },
            {
              ...
              lazy: async () => ({
                Component: (await import("@/app/pages/home/NewsDetail")).default,
              }),
            },
            {
              path: ":group/:page",
              lazy: async () => ({
                Component: (await import("@/app/pages/desktop")).default,
              }),
            },
          ],
        },
    ...
    // The app layout supports only the main layout. Avoid using it for other layouts.
    {
      ...
      children: [
        ...
        },
        {
          path: "mobile",
          lazy: async () => ({
            Component: (await import("@/app/pages/mobile-hub")).default,
          }),
        },
        {
          path: "mobile/news/:newsId",
          lazy: async () => ({
            Component: (await import("@/app/pages/home/NewsDetail")).default,
          }),
        },
